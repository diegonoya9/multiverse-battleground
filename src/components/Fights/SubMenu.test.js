...
test('renders SubMenu component', () => {
  // Renderiza SubMenu dentro de MyContextProvider con el contexto simulado
  const component = render(<SubMenu userFighter={fighter} user={user}/>)
  // Puedes agregar expectativas para asegurarte de que los elementos esperados estén presentes
  component.findByAltText('divSubMenu')
});
